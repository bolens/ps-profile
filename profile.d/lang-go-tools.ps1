# ===============================================
# lang-go-tools.ps1
# Go development tools (goreleaser, mage, lint, project build/test)
# ===============================================
# Tier: standard
...
try {
    ...
    if (Get-Command Test-FragmentLoaded -ErrorAction SilentlyContinue) {
        if (Test-FragmentLoaded -FragmentName 'lang-go-tools') { return }
    }
    ...
    if (Get-Command Set-FragmentLoaded -ErrorAction SilentlyContinue) {
        Set-FragmentLoaded -FragmentName 'lang-go-tools'
    }
}
catch {
    if (Get-Command Write-ProfileError -ErrorAction SilentlyContinue) {
        Write-ProfileError -FragmentName 'lang-go-tools' -ErrorRecord $_
    }
    else {
