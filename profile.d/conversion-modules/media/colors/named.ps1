...
.DESCRIPTION
    Sets up the complete CSS named colors dictionary from CSS Color Module Level 4 specification.
...
.NOTES
    ...
    Includes all 16 basic colors plus ~150 extended colors from SVG 1.0 and CSS specifications.
#>
function Initialize-FileConversion-MediaColorsNamed {
    ...
    $script:CssNamedColors = @{
        ...
        # Extended colors (alphabetically ordered)
