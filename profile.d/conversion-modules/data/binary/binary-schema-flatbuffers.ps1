...
try {
    ...
    if (error.code === 'MODULE_NOT_FOUND') {
        console.error('Error: flatbuffers package is not installed. Install it with: __NODE_INSTALL_CMD__');
    } else {
...
"@
            ...
            $nodeScript = Expand-EmbeddedNodeInstallHints -Script $nodeScript -PackageNames 'flatbuffers' -Global
