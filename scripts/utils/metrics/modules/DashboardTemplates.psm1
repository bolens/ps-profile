<#
scripts/utils/metrics/modules/DashboardTemplates.psm1

.SYNOPSIS
    Dashboard HTML template generation utilities.

.DESCRIPTION
    Provides functions for generating HTML dashboard templates with embedded data and JavaScript.
#>
...
.DESCRIPTION
    Creates a complete HTML dashboard with embedded CSS, JavaScript, and data.

.PARAMETER CodeMetrics
    Code metrics data object.

.PARAMETER PerformanceMetrics
    Performance metrics data object.

.PARAMETER CoverageTrends
    Coverage trends data object.

.PARAMETER HistoricalData
    Historical metrics data array.

.PARAMETER IncludeHistorical
    Whether to include historical trends section.
...
function New-DashboardHtml {
    ...
    $html = Get-DashboardHtmlTemplate -CodeMetrics $CodeMetrics -PerformanceMetrics $PerformanceMetrics -CoverageTrends $CoverageTrends -HistoricalData $HistoricalData -IncludeHistorical:$IncludeHistorical
    return $html
}

<#
.SYNOPSIS
    Generates the HTML template with embedded data and JavaScript.
