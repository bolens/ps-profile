...
.EXAMPLE
    Get-ValidationResults -Functions $functions -Exceptions @{} -ExceptionVerbs @()
#>
...
.EXAMPLE
    Write-ValidationReport -Results 'value'
#>
...
.EXAMPLE
    Save-ValidationReport -Results 'value' -OutputPath ./output.file
#>
