...
.EXAMPLE
    Get-FunctionParts -FunctionName 'value'
#>
...
.EXAMPLE
    Test-UsesAgentModeFunction -FilePath ./Taskfile.yml -FunctionName 'value'
#>
...
.EXAMPLE
    Test-IsBootstrapFunction -FilePath ./Taskfile.yml -FunctionName 'value'
#>
