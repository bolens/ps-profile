...
- `markdown-to-confluence` - Converts markdown between dialects/standards using pandoc.
- `markdown-to-jira` - Converts markdown between dialects/standards using pandoc.
