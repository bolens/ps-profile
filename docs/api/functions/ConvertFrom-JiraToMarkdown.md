...
- `confluence-to-markdown` - Converts markdown between dialects/standards using pandoc.
- `jira-to-markdown` - Converts markdown between dialects/standards using pandoc.
