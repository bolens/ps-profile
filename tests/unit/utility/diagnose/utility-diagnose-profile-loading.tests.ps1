<#
tests/unit/utility-diagnose-profile-loading.tests.ps1

.SYNOPSIS
    Behavioral unit tests for diagnose-profile-loading.ps1 smoke execution.
#>
...
Describe 'diagnose-profile-loading.ps1 execution' {
    It 'Prints profile path diagnostics without loading the profile' {
