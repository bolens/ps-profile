<#
tests/unit/test-runner/run/test-runner-run-pester.tests.ps1
...
Describe 'run-pester.ps1 Multiple Test Files' {
    ...
    It 'Accepts multiple test files via TestFile parameter' {
        $testFiles = @(
            'tests/unit/library/common/library-common.tests.ps1',
            'tests/unit/test-runner/run/test-runner-run-pester.tests.ps1'
        )
...
Describe 'run-pester.ps1 Additional Flags' {
    ...
    It 'Accepts Randomize and reports randomized order for multiple test files' {
        $testFiles = @(
            'tests/unit/library/common/library-common.tests.ps1',
            'tests/unit/test-runner/modules/discovery/test-runner-test-discovery.tests.ps1'
