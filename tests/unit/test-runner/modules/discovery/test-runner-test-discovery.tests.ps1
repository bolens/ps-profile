...
Describe 'TestDiscovery Module Tests' {
    Context 'Get-TestPaths' {
        ...
        It 'Returns specific test file when TestFile is provided' {
            $testFile = 'tests/unit/library/common/library-common.tests.ps1'
    ...
    Context 'Get-ShuffledTestPaths' {
        It 'Returns a single path unchanged' {
            $path = Join-Path $script:TestRepoRoot 'tests/unit/library/common/library-common.tests.ps1'
    ...
    Context 'Filter-TestPaths' {
        ...
        It 'Allows explicit test-runner file when it is the only path' {
            $runnerTest = Join-Path $script:TestRepoRoot 'tests/unit/test-runner/run/test-runner-run-pester.tests.ps1'
        ...
        It 'Skips paths that do not exist' {
            $validFile = Join-Path $script:TestRepoRoot 'tests/unit/library/common/library-common.tests.ps1'
