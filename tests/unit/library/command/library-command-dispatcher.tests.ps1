# ===============================================
# library-command-dispatcher.tests.ps1
...
Describe 'CommandDispatcher.psm1' {
    BeforeEach {
    ...
    Describe 'Register-CommandDispatcher' {
    ...
    Describe 'Unregister-CommandDispatcher' {
    ...
    Describe 'Test-CommandDispatcherRegistered' {
    It 'Returns false when dispatcher is not registered' {
        if (Get-Command Test-CommandDispatcherRegistered -ErrorAction SilentlyContinue) {
            Test-CommandDispatcherRegistered | Should -Be $false
        }
    ...
    Describe 'Invoke-CommandDispatcher' {
    BeforeEach {
