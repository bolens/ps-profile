...
BeforeAll {
    ...
    Import-Module (Join-Path $libPath 'FileSystem.psm1') -DisableNameChecking -Force -Global
    Import-Module (Join-Path $libPath 'Logging.psm1') -DisableNameChecking -Force -Global
    Import-Module (Join-Path $libPath 'PathResolution.psm1') -DisableNameChecking -Force -Global
