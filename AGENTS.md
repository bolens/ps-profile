...
- Unit tests: `tests/unit/**/*.tests.ps1` — category subdirectories (`library/`, `profile/`, `utility/`, …);
  keep filename prefixes (`library-`, `profile-`, `utility-`, `validation-`, `test-runner-`, `test-support*`)
